...
HTTPResponse.setCookie("PD-ID","expired; Path=/; Domain=hyperv.lab; Expires=Sun, 01-Jan-1995 01:00:00 GMT; HTTPOnly; Secure")

--[[
(Explanation copied from response-eai-logout-expire-failover-cookie-domain.xsl)
