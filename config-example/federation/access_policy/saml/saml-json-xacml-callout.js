/*
*		Title: saml20-json-xacml-callout.js
...
*				- Name : 'saml20-json-xacml-callout'
*				- Type : JavaScript
*				- Category : 
*/
...
importMappingRule("saml20-json-rtss-utils");
importMappingRule("saml20-access-policy-utilities");
