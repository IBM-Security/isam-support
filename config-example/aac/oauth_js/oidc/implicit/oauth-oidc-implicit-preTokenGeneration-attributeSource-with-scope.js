/*
	File Name : oauth-oidc-implicit-preTokenGeneration-attributeSource-with-scope.js
...
if (customize_id_token) {
	...
	if (populate_id_token || save_cred_attrs) {
		...
		// Begin processing of scope
		/*
		* Scope processing utlizes the boolean switches from our earlier code on lines 769 - 799
