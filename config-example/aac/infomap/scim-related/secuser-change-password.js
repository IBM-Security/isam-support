...
//
var patchJson = '{"schemas":["urn:ietf:params:scim:schemas:extension:isam:1.0:PatchOp"],"Operations":[{ "op":"replace","path":"urn:ietf:params:scim:schemas:extension:isam:1.0:User:password","value": "' + password + '"}]}';
