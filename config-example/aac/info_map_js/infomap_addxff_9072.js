...
IDMappingExtUtils.traceString("Entering Infomap: infomap_addxff_9072.js");
...
if(addxff != null && addxff != "" && addxff != "null" && addxff != "missing"){
	...
	context.set(Scope.REQUEST, "urn:ibm:security:asf:response", "targetURL", Target);
...
IDMappingExtUtils.traceString("Exiting infomap_addxff_9072.js");