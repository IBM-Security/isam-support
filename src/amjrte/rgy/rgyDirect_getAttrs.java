...
public class rgyDirect_getAttrs {
        public static void main(String[] args) {
                ...
                try {
                        ...
                        System.out.println("   secPwdLastChanged = " + regUser.getOneAttributeValue("secPwdLastChanged"));
                        System.out.println("   passwordMaxAge    = " + regUser.getOneAttributeValue("passwordMaxAge"));
                }
                catch (RgyException re) {
                        re.printStackTrace();
